...
class TestExplainabilityAgent:
    ...
    def test_generate_score_breakdown(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_generate_factor_analysis(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_generate_root_cause_analysis(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_generate_temporal_analysis(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_generate_comparative_analysis(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_comparative_analysis_disabled(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_signal_factor_analysis(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_entity_factor_analysis(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_root_cause_identification(
        ...
        if root_cause_explanations:
            ...
            critical_vuln_factors = [
                factor
                for factor in root_cause["factors"]
    ...
    def test_explanation_coverage_calculation(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_actionable_insights_counting(
        self, explainability_agent, sample_context, sample_scoring_result
    ):
    ...
    def test_property_weighting(self, explainability_agent):
        ...
        if factor_analysis_explanations:
            ...
            high_weight_properties = [
                factor for factor in property_factors if factor["weight"] > 0.5
            ]
    ...
    def test_real_world_critical_vulnerability_scenario(self, explainability_agent):
        ...
        if score_breakdown_explanations:
            ...
            vulnerability_factors = [
                factor for factor in breakdown["factors"] if "vulnerability" in factor["name"]
            ]
