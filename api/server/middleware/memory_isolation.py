...
class ContainerIsolator:
    ...
    def execute_isolated(
        ...
        try:
            ...
            docker_cmd = [
                "docker", "run", "--rm",
                "--memory", f"{self.config.resource_limits.max_memory_mb}m",
                "--cpus", "1",
                "--pids-limit", str(self.config.resource_limits.max_processes),
...
class IsolationManager:
    ...
    def create_isolator(self, config: IsolationConfig = None) -> Union[ProcessIsolator, ContainerIsolator]:
