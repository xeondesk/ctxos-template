...
class TestAgentEndpoints:
    ...
    def test_run_agent_with_scoring_result(self, client, admin_token, sample_context, sample_scoring_result):
    ...
    def test_list_agents(self, client, admin_token):
        ...
        agents = data["agents"]
        expected_agents = ["context_summarizer", "gap_detector", "hypothesis_generator", "explainability"]
