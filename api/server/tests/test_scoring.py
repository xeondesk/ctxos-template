...
class TestScoringEndpoints:
    ...
    def test_score_entity_success(self, client, admin_token, sample_context):
        ...
        response = client.post(
            ...
            json={"context": sample_context, "engines": ["risk"], "include_recommendations": True},
        )
    ...
    def test_score_entity_unauthorized(self, client, sample_context):
        ...
        response = client.post(
            "/api/v1/score", json={"context": sample_context, "engines": ["risk"]}
        )
    ...
    def test_score_entity_invalid_engines(self, client, admin_token, sample_context):
        ...
        response = client.post(
            "/api/v1/score",
            headers={"Authorization": f"Bearer {admin_token}"},
            json={"context": sample_context, "engines": ["invalid_engine"]},
        )
    ...
    def test_batch_scoring_success(self, client, admin_token):
        ...
        response = client.post(
            "/api/v1/score/batch",
            headers={"Authorization": f"Bearer {admin_token}"},
            json={"contexts": contexts, "engines": ["risk"], "parallel": True},
        )
    ...
    def test_batch_scoring_too_many_entities(self, client, admin_token):
        ...
        contexts = [
            {"entity": {"id": f"host-{i:03d}", "entity_type": "host"}, "signals": []}
        ...
        response = client.post(
            "/api/v1/score/batch",
            headers={"Authorization": f"Bearer {admin_token}"},
            json={"contexts": contexts, "engines": ["risk"]},
        )
    ...
    def test_get_available_engines(self, client, admin_token):
        ...
        response = client.get(
            "/api/v1/score/engines", headers={"Authorization": f"Bearer {admin_token}"}
        )
    ...
    def test_get_aggregate_scores(self, client, admin_token):
        ...
        response = client.post(
            ...
            headers={"Authorization": f"Bearer {admin_token}"},
            json={"entity_ids": ["host-001", "host-002", "host-003"], "engines": ["risk"]},
        )
    ...
    def test_compare_entities(self, client, admin_token):
        ...
        response = client.post(
            ...
            headers={"Authorization": f"Bearer {admin_token}"},
            json={"entity_ids": ["host-001", "host-002"], "engines": ["risk"]},
        )
    ...
    def test_compare_entities_invalid_count(self, client, admin_token):
        ...
        response = client.post(
            "/api/v1/score/compare",
            headers={"Authorization": f"Bearer {admin_token}"},
            json={"entity_ids": ["host-001"], "engines": ["risk"]},  # Only one entity
        )
    ...
    def test_get_scoring_status(self, client, admin_token):
        ...
        response = client.get(
            "/api/v1/score/status", headers={"Authorization": f"Bearer {admin_token}"}
        )
...
class TestScoringValidation:
    ...
    def test_invalid_context_structure(self, client, admin_token):
        ...
        response = client.post(
            "/api/v1/score",
            headers={"Authorization": f"Bearer {admin_token}"},
            json={"context": {"invalid": "structure"}, "engines": ["risk"]},
        )
    ...
    def test_invalid_entity_type(self, client, admin_token):
        ...
        response = client.post(
            ...
            json={
                "context": {
                    "entity": {"id": "test-001", "entity_type": "invalid_type", "name": "test"},
                    "signals": [],
                },
                "engines": ["risk"],
            },
...
class TestScoringPermissions:
    ...
    def test_analyst_can_get_engines(self, client, analyst_token):
        ...
        response = client.get(
            "/api/v1/score/engines", headers={"Authorization": f"Bearer {analyst_token}"}
        )
    ...
    def test_analyst_can_get_status(self, client, analyst_token):
        ...
        response = client.get(
            "/api/v1/score/status", headers={"Authorization": f"Bearer {analyst_token}"}
        )
