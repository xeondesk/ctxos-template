...
class TestEntity:
    ...
    def test_entity_creation(self):
        ...
        entity = Entity(name="example.com", entity_type=EntityType.DOMAIN, source="dns_collector")
...
class TestSignal:
    ...
    def test_signal_expiry(self):
        ...
        signal = Signal(source="collector", signal_type=SignalType.OPEN_PORT, data={}, expiry=past)
    ...
    def test_signal_not_expired(self):
        ...
        signal = Signal(
            source="collector", signal_type=SignalType.OPEN_PORT, data={}, expiry=future
        )
    ...
    def test_signal_to_dict(self):
        ...
        signal = Signal(
            source="dns_collector", signal_type=SignalType.DNS_RECORD, data={"record_type": "A"}
        )
    ...
    def test_signal_tags(self):
        ...
        signal = Signal(source="collector", signal_type=SignalType.OPEN_PORT, data={})
...
class TestContext:
    ...
    def test_context_add_entity(self):
        ...
        entity = Entity(name="example.com", entity_type=EntityType.DOMAIN, source="dns")
    ...
    def test_context_get_entities_by_type(self):
        ...
        entity1 = Entity(name="example.com", entity_type=EntityType.DOMAIN, source="dns")
        entity2 = Entity(name="example.org", entity_type=EntityType.DOMAIN, source="dns")
        entity3 = Entity(name="1.2.3.4", entity_type=EntityType.IP_ADDRESS, source="dns")
    ...
    def test_context_get_signals_for_entity(self):
        ...
        signal1 = Signal(
            source="collector", signal_type=SignalType.DNS_RECORD, data={}, entity_id=entity.id
        )
        signal2 = Signal(
            source="collector", signal_type=SignalType.CERTIFICATE, data={}, entity_id=entity.id
        )
    ...
    def test_context_from_dict(self):
        ...
        data = {
            ...
            "name": "Test Context",
            "entities": [
                {"id": "ent-1", "name": "example.com", "entity_type": "domain", "source": "dns"}
            ],
            "signals": [],
        }
