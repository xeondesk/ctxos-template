...
from core.schema import SchemaRegistry, SchemaVersion, get_registry, validate_schema, get_schema
...
class TestSchemaVersion:
    ...
    def test_schema_version_creation(self):
        ...
        version = SchemaVersion(version="1.0.0", name="Initial Release", schema={"type": "object"})
...
class TestGlobalRegistry:
    ...
    def test_validate_schema_function(self):
        ...
        entity_data = {"name": "example.com", "entity_type": "domain", "source": "dns_collector"}
