...
class TestDictUtils:
    ...
    def test_flatten_dict(self):
        ...
        data = {"user": {"name": "John", "address": {"city": "NYC"}}, "age": 30}
    ...
    def test_unflatten_dict(self):
        ...
        flat = {"user.name": "John", "user.address.city": "NYC", "age": 30}
    ...
    def test_compact_dict(self):
        ...
        data = {"name": "John", "age": None, "email": "", "tags": [], "city": "NYC"}
