...
class DriftEngine(BaseEngine):
        ...
        try:
            ...
            return ScoringResult(
                ...
                metrics={
                    ...
                    "signal_drift": min((metrics.modified_signals + metrics.new_signals) * 10, 100),
    ...
    def _calculate_drift_score(self, metrics: DriftMetrics) -> float:
        ...
        property_drift = (
            metrics.property_changes + metrics.new_properties * 2 + metrics.removed_properties * 1.5
        )
        ...
        signal_drift = (
            metrics.modified_signals + metrics.new_signals * 1.5 + metrics.removed_signals
        )
    ...
    def _generate_recommendations(self, metrics: DriftMetrics, score: float) -> List[str]:
    ...
    def validate_config(self, config: Dict[str, Any]) -> bool:
        ...
        weight_sum = config.get("property_change_weight", 0) + config.get("signal_change_weight", 0)
