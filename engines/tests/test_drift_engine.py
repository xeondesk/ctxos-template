...
class TestDriftEngine:
    ...
    def test_first_time_entity_scoring(self, engine):
        ...
        entity = Entity(name="new.example.com", entity_type=EntityType.DOMAIN, source="test")
    ...
    def test_empty_baseline_entity(self, engine):
        ...
        entity = Entity(name="minimal.example.com", entity_type=EntityType.DOMAIN, source="test")
    ...
    def test_entity_with_many_properties(self, engine):
        ...
        entity = Entity(name="complex.example.com", entity_type=EntityType.DOMAIN, source="test")
