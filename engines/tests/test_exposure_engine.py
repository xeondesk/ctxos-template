...
class TestExposureEngine:
    ...
    def domain_entity(self):
        ...
        return Entity(name="example.com", entity_type=EntityType.DOMAIN, source="test")

    @pytest.fixture
    def ip_entity(self):
        """Create sample IP entity."""
        return Entity(name="192.0.2.1", entity_type=EntityType.IP_ADDRESS, source="test")

    @pytest.fixture
    def service_entity(self):
        """Create sample service entity."""
        return Entity(name="web-service", entity_type=EntityType.SERVICE, source="test")
