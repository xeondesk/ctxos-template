...
class TestEngineIntegration:
    ...
    def test_three_engine_pipeline(self, risk_engine, exposure_engine, drift_engine, sample_context):
        ...
        for entity in entities:
            ...
            assert all(isinstance(r, ScoringResult) for r in [risk_result, exposure_result, drift_result])
    ...
    def test_aggregate_multiple_scores(self, risk_engine, exposure_engine, drift_engine, sample_context):
    ...
    def test_weighted_score_aggregation(self, risk_engine, exposure_engine, drift_engine, sample_context):
        ...
        for entity in entities:
            ...
            weighted_score = (
                ...
                exposure_score * weights[1] +
                drift_score * weights[2]
            )
    ...
    def test_serialize_all_results(self, risk_engine, exposure_engine, drift_engine, sample_context):
    ...
    def test_deserialize_all_results(self, risk_engine, exposure_engine, drift_engine, sample_context):
    ...
    def test_high_risk_asset_detection(self, risk_engine, exposure_engine, sample_context):
        ...
        if risk_result.score > 60 or exposure_result.score > 60:
            assert risk_result.severity in ["critical", "high"] or \
                   exposure_result.severity in ["critical", "high"]
    ...
    def test_batch_scoring_performance(self, risk_engine):
        ...
        domain = context.entities[0] if context.entities else Entity(name="test.example.com", entity_type=EntityType.DOMAIN, source="test")
